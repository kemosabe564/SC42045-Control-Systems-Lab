...
%T_equation = T == k_m * u - tau_e * T_d; 
T_equation = T == -k_m * u - tau_e * T_d; % minus before the k_m because some problem in the equations
...
%% Save this to file
save('NonLinFunc.mat','NonLinFunc','system_f')
