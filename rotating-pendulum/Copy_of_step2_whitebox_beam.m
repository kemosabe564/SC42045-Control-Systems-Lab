...
% 
% [P1, P2, P3, g1, g2] = setparams(params_init);
% 
% params = params_init;
% simulink_params = params;
% simulink_params1= [g1 g2 P1 P2 P3];
% 
% ym = sim('Copy_of_nonlinear_model');
% ym = [ym.nonlinearSim(:, 1) ym.nonlinearSim(:, 2)];
% 
% figure(3); stairs(t, [ym(:, 2)]); 
% 
% 
% params_init = [9.81, 0.1, 0.1, 0.125, 0.05, -0.03, 0.08, 0.12, 0.00002, 30, 0.00002, 80, 0.09];
% params_lb = [9.81, 0.1, 0.1, 0.125, 0.05, -0.03, 0.03, 0.12, 0.000001, 30, 0.000001, 80, 0.09];
% params_ub = [9.81, 0.1, 0.1, 0.125, 0.05, -0.03, 0.09, 0.12, 0.00005, 30, 0.00005, 80, 0.09];
% 
% 
...
% 
% function [P1, P2, P3, g1, g2] = setparams(params_init)
%     g = params_init(1);
%     l_1 = params_init(2);
%     l_2 = params_init(3);
%     m_1 = params_init(4);
